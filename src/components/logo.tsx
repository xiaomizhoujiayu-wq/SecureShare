export function SecureShareLogo({ className = "w-8 h-8" }: { className?: string }) {
  return (
    <svg 
      viewBox="0 0 24 24" 
      fill="none" 
    ...
    >
      <defs>
        ...
        <linearGradient id="abe-logo-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      {/* data */}
      <circle cx="12" cy="12" r="3" stroke="url(#abe-logo-gradient)" strokeWidth="1.5" />
